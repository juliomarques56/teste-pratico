...
import {loanPageSelectors as loanPgSel, supportPageSelectors as supportPgSel} from '../support/selectors/loanPageSelectors'
  ...
  resolutions.forEach(resolution => {
    ...
    context(`Teste em resolução ${resolution.id}`, () => { 
      ...
      it('Validar conteúdo inicial da página de empréstimos', () => {
        ...
        cy.validatePageContent(loanPgSel.helpCenterText, testData.helpCenterText)
      ...
      it('Validar mensagem de erro ao informar CPF inválido', () => {
        ...
        cy.validateErrorMessage(loanPgSel.errorMessage, testData.invalidCpfError)
      ...
      it('Validar mensagem de erro para campo CPF obrigatório', () => {
        ...
        cy.validateErrorMessage(loanPgSel.errorMessage, testData.requiredFieldError)
      ...
      it('Validar alteração do contorno do campo cpf ao clicar em Acessar sem informar cpf', () => {
        ...
        cy.get(loanPgSel.outline).should('have.class', 'mat-form-field-invalid')
      ...
      it('Verificar link para Central de Ajuda', () => {
        ...
        cy.origin('https://picpay.com', { args: { supportPgSel, resolution } }, ({ supportPgSel, resolution }) => {
          ...
          cy.screenshot(`pagina-central-ajuda_${resolution.width}x${resolution.height}`) 
        });
      })
    }); 
  });
